                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                         ...
                         <div id="time_data" style="display:none;">
                        ...
                        <!-- <ul style="padding-left:0px;" class="psychic-off-day">
                         @foreach(getTimeFrame15Min() as $key=> $time15min)
                           ...
                           <li class="adtm">
                           <span class="spn1">{{ Form::checkbox('off_time[]',$time15min,null, array('id'=>'off_time_'.$key,'class'=>'chk_ot')) }}</span>

                           <span>{{ date("g:i A", strtotime($time15min)) }}</span>
                           </li>
                         @endforeach -->
