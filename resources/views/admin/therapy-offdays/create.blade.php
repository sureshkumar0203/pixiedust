...
@section('title','Add Massage Therapy Off Days')
@section('content')
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Add Therapy Off Days</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('admin/home') }}">Home</a></li>
            <li class="breadcrumb-item active">Add Therapy Off Days</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12"> 
          ...
          <div class="card card-primary"> @include('admin.includes.msg')
            <div class="card-header">
              <h3 class="card-title">Add Therapy Off Days</h3>
            </div>
            {{ Form::open(['route' => 'therapy-offdays.store','data-toggle'=>"validator", 'role' => 'form', 'class' =>'validate', 'name' => 'add-therapy-offdays', 'id' => 'add-therapy-offdays','files'=>true, 'autocomplete' => 'off']) }}
            <div class="card-body">
              <div class="form-group">
                ...
                @if ($errors->has('booking_date')) <span class="help-block"> <strong>{{ $errors->first('booking_date') }}</strong> </span> @endif
            ...
            <div class="card-footer"> {{ Form::submit('Save', ['class' => 'btn btn-success']) }} <a href="{{ url('admin/therapy-offdays') }}" class="btn btn-warning">Back</a> </div>
            {!! Form::close() !!} </div>
        </div>
      </div>
      <!-- /.row --> 
...
function checkBookedTime(inputDate) {
	if (inputDate) {
		...
		$.ajax({
			type: "POST",
			cache: false,
			url: '{{ url("/check-therapy-booked-time") }}',
