                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary"> @include('admin.includes.msg')
                        <div class="card-header">
                            <h3 class="card-title">Add Coupon Code</h3> </div> 
                        {{ Form::open(['route' => 'coupon-code.store','data-toggle'=>"validator", 'role' => 'form', 'class' =>'validate', 'name' => 'add-coupon', 'id' => 'add-coupon','files'=>true, 'autocomplete' => 'off']) }}
                        <div class="card-body">                           
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ url('admin/coupon-code') }}" class="btn btn-warning">Back</a> </div> 
                        {!! Form::close() !!} 
                    </div>
                </div>
            </div>
