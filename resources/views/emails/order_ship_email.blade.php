                                    ...
                                    <tr>
                                        <td class="tablepadding" style="border-top: 1px solid #eaeaea; font-size:14px; border-bottom: 1px solid #eaeaea; padding: 13px 20px; background: #f3f3f3;">
                                            <table width="100%" border="0" cellspacing="20" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <p>Your order no <strong>{{ $data['order_id'] }}</strong> has been shipped successfully.The tracking code is <strong>{{ $data['tracking_id'] }}</strong>.You can track your order here <a href="{{ $data['shipping_url'] }}">{{ $data['shipping_url'] }}</a> </p>
                                                    </td>
                                                </tr>
                                                <tr>
