                                    ...
                                    <tr>
                                        <td class="tablepadding" style="border-top:1px solid #eaeaea;border-bottom:1px solid #eaeaea;padding:13px 20px;"><table width="100%" align="center" cellpadding="0" cellspacing="20" border="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767">
                                                            <span>Your Intuitive Reading Booking Details Below. </span>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="21%" style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767"><strong><span style="color:#707070">Booking Date :</span></strong></td>
                                                        <td width="79%" align="left" style="font-size:14px; font-family:Arial, Helvetica, sans-serif; color:#676767"><span style="color: #707070">{{ $booking_date }}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767"><strong>Booking TIme Peroid :</strong></td>
                                                        <td align="left" style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767">{{ $booking_time }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767"><strong>Booking TIme Slot :</strong></td>
                                                        <td align="left" style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767">{{ $booking_mins }} Mins</td>
                                                    </tr>
