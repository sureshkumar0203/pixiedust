                        ...
                        <div class="cart">
                        	@if($getProductDetails->prd_cs_opt==1)
                              ...
                              <table class="table tbl-w">
                                <tr class="pr-det">
                                  <td width="33%" align="left" valign="middle" class="bdr-btm pad5 col-b">Color</td>
                                  <td width="33%" align="left" valign="middle" class="bdr-btm pad5 col-b">Size</td>
                                  <td width="33%" align="center" valign="middle" class="bdr-btm pad5 col-b">Stock</td>
                                </tr>
                                @foreach(getColorSizeDetails($getProductDetails->id) as $prd_stock_dtls)
                               
                                <tr class="bdr-btm  sto_dis_cls">
                                  <td align="left" valign="middle" class="pad5"><label class="st"> {{ Form::radio('prd_stock_id', $prd_stock_dtls->id , false, array('id'=>'prd_stock_id','class'=>'','placeholder'=>'')) }} <span class="checkmark" style="background:#<?php echo $prd_stock_dtls->color->color_code;?>;"></span>{{ $prd_stock_dtls->color->color }}</label></td>
                                  <td align="left" valign="middle" class="pad5"> {{ $prd_stock_dtls->size->size }} </td>
                                  <td align="center" valign="middle" class="pad5">{{ $prd_stock_dtls->stock }} </td>
